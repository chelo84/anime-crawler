...
class AnimeItemParser:
    ...
    def parse_anime(response):
        ...
        anime_item['score'] = "{:.2f}".format(float(ExtractUtils.extract_x_path(response, '//*[@id="siteContainer"]/section[1]/div[4]/div/meta[1]/@content').get(default=0.0)))
        anime_item['scored_by'] = ExtractUtils.extract_x_path(response, '//*[@id="siteContainer"]/section[1]/div[4]/div/meta[4]/@content').get(default=0)
